...
import { Row, Col, Typography, Button, InputNumber, Divider, Tag, Tabs, Breadcrumb, Skeleton, message } from "antd"
import {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Breadcrumb className="mb-6">
        ...
        <Breadcrumb.Item>{loading ? <Skeleton.Button active size="small" /> : product?.name}</Breadcrumb.Item>
      </Breadcrumb>
            ...
            product && (
              <>
                ...
                <div className="flex items-center mb-4">
                  <Text className="text-2xl font-bold mr-4">${product.price.toFixed(2)}</Text>
                  {product.discount && (
                ...
                <Text className="text-gray-600 block mb-6">{product.description}</Text>
                ...
                <div className="flex items-center mb-4">
                  ...
                  {product.inStock ? (
                    <Tag icon={<CheckCircleOutlined />} color="success" className="mr-4">
                      In Stock
                    </Tag>
                  ) : (
                    <Tag icon={<CloseCircleOutlined />} color="error" className="mr-4">
                      Out of Stock
                    </Tag>
                  )}
                ...
                <div className="flex items-center mb-6">
                  ...
                  />
                  <Text className="ml-4 text-gray-500">{product.stockQuantity} available</Text>
                </div>
          ...
          <Tabs defaultActiveKey="1">
            ...
            <TabPane tab="Shipping" key="2">
              <div className="p-4">
                ...
                <Text>
                  We ship to most countries worldwide. Shipping costs are calculated at checkout based on weight,
