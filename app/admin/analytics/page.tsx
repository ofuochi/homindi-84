...
export default function AnalyticsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const [overviewData, salesData, customerData, performanceData] =
          await Promise.all([
                ...
                <Row gutter={[16, 16]}>
                  ...
                  <Col xs={24} sm={12} lg={6}>
                    <MetricCard
                      ...
                      value={
                        customerAnalytics?.newCustomers[0]?.newCustomers || 0
                      }
                      loading={loading}
                    />
                  </Col>
              ...
              children: (
                <Row gutter={[16, 16]}>
                  <Col xs={24} sm={12} lg={6}>
                    <MetricCard
                      title="Page Views"
                      value={performanceMetrics?.pageViews || 0}
                      loading={loading}
                    />
                  </Col>
                  <Col xs={24} sm={12} lg={6}>
                    <MetricCard
                      ...
                      value={performanceMetrics?.uniqueVisitors || 0}
                      loading={loading}
                    />
                  </Col>
                  <Col xs={24} sm={12} lg={6}>
